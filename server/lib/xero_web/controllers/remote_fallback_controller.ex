defmodule XeroWeb.RemoteFallbackController do
  ...
  defp status_and_message(:desktop_required),
    do: {:forbidden, "A desktop device token is required."}
  ...
  defp status_and_message(:invalid_kind),
    do: {:bad_request, "Device kind must be desktop or web."}
  ...
  defp status_and_message(:cannot_revoke_self),
    do: {:bad_request, "Desktop device cannot revoke itself."}
