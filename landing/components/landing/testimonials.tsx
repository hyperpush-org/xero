...
const testimonials: Testimonial[] = [
  {
    quote:
      "I kicked off a Stripe-powered SaaS before a flight. Landed, opened my laptop, and Xero was waiting with a green PR and a deploy preview. It had flagged two decisions for me mid-air — I cleared them from my phone browser.",
    name: "Maya Chen",
  ...
  {
    quote:
      "Remote sessions are absurdly well-tuned. I get the exact diff and tradeoff, not a vague 'need your input'. I approve in one tap from a browser.",
    name: "Theo Marín",
