    ...
    <section className="rounded-2xl border border-border/70 bg-card/80 p-5 shadow-sm">
      <div className="flex flex-col gap-4">
        ...
        <p className="text-sm leading-6 text-muted-foreground">
          Xero correlates live action-required hints with durable approvals, broker fan-out, resume history, and
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-2 text-[11px] text-muted-foreground">
            ...
            {displayValue(card.resumabilityDetail, 'Xero has not observed enough durable approval or resume evidence yet.')}
          </p>
          <p className="mt-2 text-[11px] text-muted-foreground">
        ...
        <>
          {canAnswerOwnedLiveAction ? (
            ...
            <div className="mt-4 rounded-lg border border-border/70 bg-background/70 px-3 py-3">
              ...
              <p className="mt-2 text-[12px] leading-5 text-muted-foreground">
                Xero is keeping the live, broker, resume, and evidence truth visible for this action even though there is
