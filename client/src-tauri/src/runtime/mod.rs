...
pub use autonomous_tool_runtime::{
    ...
    shutdown_desktop_control_sidecar, AutonomousAgentAttachableSkillCatalog,
...
pub use provider::{
    ...
    CURSOR_AUTO_MODEL_ID, CURSOR_DEFAULT_MODEL_ID, CURSOR_PROVIDER_ID, CURSOR_RUNTIME_KIND,
