...
pub fn migrations() -> &'static Migrations<'static> {
    static MIGRATIONS: LazyLock<Migrations<'static>> = LazyLock::new(|| {
        Migrations::new(vec![
            ...
            M::up_with_hook("", migrate_builtin_agent_workflow_structure),
...
const MIGRATION_020_PROJECT_START_COMMAND_SQL: &str = r#"
    ALTER TABLE projects ADD COLUMN start_command TEXT;
"#;

const MIGRATION_021_PROJECT_START_TARGETS_SQL: &str = r#"
...
const BUILTIN_AGENT_WORKFLOW_STRUCTURE_INSERT_SQL: &str = r#"
    ...
    VALUES
        ('generalist', 1, 'Generalist', 'Generalist', 'A do-anything agent with the full engineering toolset that recognises when a specialist agent would handle the task better and offers to route.', 'built_in', 'active', 'engineering', '2026-05-12T00:00:00Z');
"#;
...
fn migrate_builtin_agent_workflow_structure(
    ...
    if !table_exists(transaction, "agent_definition_versions")?
        || !table_exists(transaction, "agent_definitions")?
    {
        return Ok(());
    }
