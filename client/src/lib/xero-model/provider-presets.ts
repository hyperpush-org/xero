...
const CLOUD_PROVIDER_PRESETS: CloudProviderPreset[] = [
  ...
  },
  {
    ...
    label: 'OpenRouter',
    description: 'Use Grok Latest through the hosted OpenRouter API with a saved app-local API key and live model discovery.',
  ...
  },
  {
    ...
    runtimeKind: 'xai',
    label: 'xAI / Grok',
    description: "Use xAI-hosted Grok models through Xero's native Responses API adapter with a saved API key.",
    ...
    manualModelAllowed: true,
    supportsCatalogRefresh: true,
    connectionHint: 'Create an xAI API key in the SpaceXAI console and save it here.',
  },
  {
